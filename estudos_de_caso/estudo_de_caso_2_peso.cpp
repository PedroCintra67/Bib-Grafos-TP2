...
int main() {
    ...
    Caminho_Minimo_Vector(grafo_2_vector, 10, 40);
    Caminho_Minimo_Vector(grafo_2_vector, 10, 50);
    Caminho_Minimo_Vector(grafo_2_vector, 10, 60);
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_vector_heap += Dijkstra_Vector_Heap_With_Execution_Time(grafo_2_vector, rand() % grafo_2_vector.size());
    }
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_vector_vector += Dijkstra_Vector_Vector_With_Execution_Time(grafo_2_vector, rand() % grafo_2_vector.size());
    }
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_matrix_heap += Dijkstra_Matrix_Heap_With_Execution_Time(grafo2_matrix, rand() % grafo2_matrix.size());
    }
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_matrix_vector += Dijkstra_Matrix_Vector_With_Execution_Time(grafo2_matrix, rand() % grafo2_matrix.size());
    }
