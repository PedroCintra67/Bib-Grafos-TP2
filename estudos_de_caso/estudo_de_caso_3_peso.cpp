...
int main() {
    ...
    vector<vector<pair<int, float>>> grafo_3_vector = txt_to_weight_adjacency_vector(nome_arquivo);
    ...
    vector<vector<float>> grafo3_matrix = txt_to_weight_adjacency_matrix(nome_arquivo);
