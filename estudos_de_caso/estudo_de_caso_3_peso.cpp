...
int main() {
    ...
    string nome_arquivo = "grafo_W_3.txt";
    string saida_arquivo = "estudo_de_caso_3_peso.txt";
    
    vector<vector<pair<int, float>>> grafo_3_vector = txt_to_weight_adjacency_vector(nome_arquivo, "resultado_w.txt");

    Caminho_Minimo_Vector(grafo_3_vector, 10, 20);
    Caminho_Minimo_Vector(grafo_3_vector, 10, 30);
    Caminho_Minimo_Vector(grafo_3_vector, 10, 40);
    Caminho_Minimo_Vector(grafo_3_vector, 10, 50);
    Caminho_Minimo_Vector(grafo_3_vector, 10, 60);
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_vector_heap += Dijkstra_Vector_Heap_With_Execution_Time(grafo_3_vector, rand() % grafo_3_vector.size());
    }
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_vector_vector += Dijkstra_Vector_Vector_With_Execution_Time(grafo_3_vector, rand() % grafo_3_vector.size());
    }
    ...
    grafo_3_vector = vector<vector<pair<int, float>>>();

    vector<vector<float>> grafo3_matrix = txt_to_weight_adjacency_matrix(nome_arquivo, "resultado_w_matrix.txt");
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_matrix_heap += Dijkstra_Matrix_Heap_With_Execution_Time(grafo3_matrix, rand() % grafo3_matrix.size());
    }
    ...
    for (int i = 0; i < 100; i++) {
        tempo_total_dijkstra_matrix_vector += Dijkstra_Matrix_Vector_With_Execution_Time(grafo3_matrix, rand() % grafo3_matrix.size());
    }
